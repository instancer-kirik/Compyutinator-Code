...
class ProjectManager(QObject):
    ...
    project_updated = pyqtSignal(object)  # Now emits ProjectConfig object
    ...
    def update_project_config(self, project_name: str, updated_config: ProjectConfig) -> bool:
        ...
        try:
            ...
            # Save configuration
            return self.save_project_config(project)
...
class ProjectManagerWidget(QWidget):
    ...
    def update_project_list(self):
        """Update the project list for the current vault"""
        self.project_selector.clear()
        ...
        if vault_name:
            ...
            # Select current project if it exists in this vault
