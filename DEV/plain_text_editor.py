...
from PyQt6.QtWidgets import QPlainTextEdit, QWidget, QVBoxLayout, QApplication, QFileDialog, QMessageBox, QHBoxLayout, \
                         QFrame, QTextEdit, QToolBar, QComboBox, QLabel, QLineEdit, QToolButton, QMenu, QMainWindow
from PyQt6.QtGui import QIcon, QPainter, QTextFormat, QColor, QAction, QTextCursor, QKeySequence, QClipboard, QTextCharFormat, QPalette
from PyQt6.QtCore import Qt, QVariant, QRect, QDir, QFile, QFileInfo, QTextStream, QRegularExpression, QSettings
import sys, os
...
class myEditor(QMainWindow):
    def __init__(self, parent = None):
       ...
       # self.editor.setFrameStyle(QFrame:NoFrame)
        self.editor.setTabStopDistance(14)
